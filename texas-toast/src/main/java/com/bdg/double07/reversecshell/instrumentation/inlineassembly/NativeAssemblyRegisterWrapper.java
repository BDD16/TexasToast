...
public interface NativeAssemblyRegisterWrapper extends Library{
    ...
    NativeAssemblyRegisterWrapper instance = (NativeAssemblyRegisterWrapper) Native.load(("/.m2/repository/com/utece/student/llpdetection/instrumentation/inlineassembly/libassembly/1.0/libassembly-1.0.dylib"), NativeAssemblyRegisterWrapper.class);
